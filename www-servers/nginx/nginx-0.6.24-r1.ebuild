...
# $Header: /var/cvsroot/gentoo-x86/www-servers/nginx/nginx-0.6.24.ebuild,v 1.2 2007/12/31 19:54:24 voxus Exp $
...
IUSE="addition debug fastcgi flv imap pcre perl ssl status sub webdav zlib python"
WSGIPATH="/home/djc/src/nginx-mod_wsgi/"
...
src_compile() {
	...
	use python  && myconf="${myconf} --add-module=${WSGIPATH}"
